...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <strong>{!!trans('admin/breadcrumb.product.edit')!!}</strong>
        </li>
    </ol>
  </div>
</div>
    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5>{!!trans('admin/product.edit')!!}</h5>
        ...
        <div class="ibox-content">
          <form method="post" action="{{url('admin/product',[$product->id])}}" class="form-horizontal">
            {{csrf_field()}}
            {{method_field('PUT')}}
            ...
            <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="name" value="{{old('name',$product->name)}}" placeholder="{{trans('admin/product.model.name')}}">
                @if ($errors->has('name'))
            ...
            <div class="form-group{{ $errors->has('model') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10">
                <input type="text" class="form-control" name="model" value="{{old('model',$product->model)}}" placeholder="{{trans('admin/product.model.model')}}">
                @if ($errors->has('model'))
              ...
              <div class="form-group{{ $errors->has('code') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-10">
                      <input type="text" class="form-control" name="code" value="{{old('code',$product->code)}}" placeholder="{{trans('admin/product.model.code')}}">
                      @if ($errors->has('code'))
