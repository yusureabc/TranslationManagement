...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <strong>{!!trans('admin/breadcrumb.salesdata.create')!!}</strong>
        </li>
    </ol>
  </div>
</div>
    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5>{!!trans('admin/salesdata.create')!!}</h5>
        ...
        <div class="ibox-content">
          <form method="post" action="{{url('admin/salesdata')}}" class="form-horizontal">
            {{csrf_field()}}
            ...
            <div class="form-group{{ $errors->has('num') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10 input-group bootstrap-touchspin">
                  ...
                  <div class="input-group bootstrap-touchspin">
                      <input class="touchspin1 form-control" type="text" value="{{old('num')}}" name="num" placeholder="{{trans('admin/salesdata.model.num')}}" style="display: block;">
                  </div>
                @if ($errors->has('num'))
            ...
            <div class="form-group{{ $errors->has('amount') ? ' has-error' : '' }}">
              ...
              <div class="col-sm-10 input-group m-b bootstrap-touchspin">
                  <div class="input-group bootstrap-touchspin">
                    <input class="touchspin2 form-control" type="text" value="{{old('amount')}}" name="amount" placeholder="{{trans('admin/salesdata.model.amount')}}" style="display: block;">
                  </div>
              ...
              <div class="form-group{{ $errors->has('data_time') ? ' has-error' : '' }}">
                  ...
                  <div class="col-sm-10">
                      <div class="input-group date">
                          ...
                          <input type="text" class="form-control" name="data_time" value="{{date('Y-m-d', strtotime('-1 day'))}}" placeholder="{{trans('admin/salesdata.model.data_time')}}">
                      </div>
