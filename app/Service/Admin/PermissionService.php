...
class PermissionService extends BaseService
{
     ...
     * 权限写入配置
     * @author Sheldon
     * @date   2017-04-19T10:44:11+0800
     * @return [type]                   [Array]
     */
    public function setPermissionConfig()
    {
        ...
        if ($permissions) {
            foreach ($permissions as $v) {
                array_set($array, $v->slug, $v->slug);
            }
        }

        $writeConfig = new Rewrite;
        $writeConfig->toFile(config_path('admin/permissions.php'), $array, false);
