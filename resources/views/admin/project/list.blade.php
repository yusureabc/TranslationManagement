...
<div class="row wrapper border-bottom white-bg page-heading">
  <div class="col-lg-10">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">
            <strong>{!!trans('admin/breadcrumb.project.list')!!}</strong>
        </li>
    </ol>
  </div>
  @permission(config('admin.permissions.project.create'))
  <div class="col-lg-2">
    <div class="title-action">
      <a href="{{url('admin/project/create')}}" class="btn btn-info">{!!trans('admin/project.action.create')!!}</a>
    </div>
  </div>
  @endpermission
</div>
    ...
    <div class="col-lg-12">
      <div class="ibox float-e-margins">
        <div class="ibox-title">
          <h5>{!!trans('admin/project.desc')!!}</h5>
              ...
              <table class="table table-striped table-bordered table-hover dataTablesAjax" >
                  <thead>
                      <tr>
                        ...
                        <th>{{trans('admin/project.model.created_at')}}</th>
                        <th>{{trans('admin/project.model.updated_at')}}</th>
...
<script src="{{asset('admin/js/project/project-datatable.js')}}"></script>
